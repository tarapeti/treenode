...
@SpringBootTest
public class JsonHwApplicationTests {
    ...
    public void test1() {
        ...
        List<Integer> actual = searchIds(TravelsalMode.DEPTH_FIRST, 3, root);
    ...
    public void test2() {
        ...
        List<Integer> actual = searchIds(TravelsalMode.BREADTH_FIRST, 2, root);
        Assert.assertEquals(expected, actual);
    }
    ...
    private List<Integer> searchIds(TravelsalMode mode, int depth, TreeNode root) {
        if (mode == TravelsalMode.DEPTH_FIRST) {
    ...
    private void depthFirstSearch(List<Integer> result, int targetDepth, int currentDepth, TreeNode node) {
        ...
        for (TreeNode childNode : children) {
            ...
            depthFirstSearch(result, targetDepth, currentDepth, childNode);
        }

        // Implement recursive depth-first search traversal here.
    }

    private List<Integer> breadthFirstSearch(int targetDepth, TreeNode node) {
        // Implement non-recursive breadth-first search traversal here.
        return null;
    }
}
